...
short DrawTimes = 0;
enWinner GameWinner;//cheak Winner between p1 and computer
string WinnerName = "";//to print result
};
...
string WinnerName(enWinner Winner)//Storing the winner's Value
{
    string arrWinnerName[3] = {"Player1" , "Computer" , "No Winner"};
    return arrWinnerName[Winner - 1];//value enum 123 return string index 012 
}
...
void SetWinnerScreenColor(enWinner Winner)// element the struct is type enum 
{
    switch (Winner)
    {
