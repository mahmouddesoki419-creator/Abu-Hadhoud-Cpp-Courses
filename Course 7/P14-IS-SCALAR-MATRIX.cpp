...
{
	int scalarNum = Matrix1[0][0];
	for(int i = 0; i < rows; i++)
	{
		for(int j = 0; j < cols; j++)
		{// cheack for diagonals element 
			if(i == j && Matrix1[i][j] != scalarNum) // بمجرد شرط ميتحققش مش ايكمل 
			{
				return false;
	...
	return true;//  ف مفروض فوق في الشروط يكمل مساوي الفاريبال  وشرط تاني يكمل 0 للعنصر الاخر 
}//mahmo
